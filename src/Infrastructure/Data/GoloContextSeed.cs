...
OS : Windows 7 64 - bit"
	...
	STORAGE: 55 GB available space",
            ...
            var product22 = new Product() { Game = game8, Platform = p3, ProductUnitPrice = 40.99m, IsAvailable = true, IsEditorsChoice = false };
            var product23 = new Product() { Game = game9, Platform = p4, ProductUnitPrice = 50.99m, IsAvailable = true, IsEditorsChoice = false };
            var product24 = new Product() { Game = game10, Platform = p5, ProductUnitPrice = 60.99m, IsAvailable = true, IsEditorsChoice = false };
            var product25 = new Product() { Game = game11, Platform = p6, ProductUnitPrice = 70.99m, IsAvailable = true, IsEditorsChoice = false };
            var product26 = new Product() { Game = game12, Platform = p1, ProductUnitPrice = 80.99m, IsAvailable = true, IsEditorsChoice = false };
            var product27 = new Product() { Game = game13, Platform = p2, ProductUnitPrice = 90.99m, IsAvailable = true, IsEditorsChoice = false };
